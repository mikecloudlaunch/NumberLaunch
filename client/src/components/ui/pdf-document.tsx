          ...
          <View style={styles.table}>
            ...
            {taxResult.taxByBracket.map((bracket, index) => (
              <View key={index.toString()} style={styles.tableRow}>
                ...
                <Text style={styles.tableCol2}>{bracket.rate === 32.5 ? '32.5¢' : bracket.rate === 0 ? '0.0¢' : bracket.rate === 19 ? '19.0¢' : bracket.rate === 37 ? '37.0¢' : bracket.rate === 45 ? '45.0¢' : `${bracket.rate.toFixed(1)}¢`}</Text>
