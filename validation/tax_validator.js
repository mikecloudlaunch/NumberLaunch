...
const constants = {
  ...
  TAX_BRACKETS: [
    ...
    { min: 18201, max: 45000, rate: 0.16, base: 0 }, // Updated to 16c per dollar
    { min: 45001, max: 135000, rate: 0.30, base: 4288 }, // Updated base amount to $4,288
    { min: 135001, max: 190000, rate: 0.37, base: 31288 }, // Updated base amount to $31,288
    { min: 190001, max: Infinity, rate: 0.45, base: 51638 }  // Updated base amount to $51,638
  ],
